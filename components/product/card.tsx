...
const Card: React.FC<CardProps> = ({ product }) => {
  ...
  return (
    <div className="bg-white rounded-2xl shadow-md overflow-hidden relative p-4 sm:p-6 flex flex-col justify-between h-full">
      {isOnSale && (
      ...
      <h3 className="text-[#1B1B1B] font-semibold text-lg sm:text-xl md:text-2xl lg:text-3xl leading-tight mb-2 sm:mb-4 text-center">
        {title}
      </h3>
